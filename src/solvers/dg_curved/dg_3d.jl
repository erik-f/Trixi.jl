...
@inline function calc_interface_flux!(surface_flux_values, left_element, right_element, orientation, u, 
  ...
  @unpack surface_flux = dg
  @unpack interface_vectors, contravariant_vectors = cache.elements
  ...
  for j in eachnode(dg), i in eachnode(dg)
    ...
    normal   = get_contravariant_vector(1, interface_vectors, i, j, left_direction, right_element)
    tangent1 = get_contravariant_vector(2, interface_vectors, i, j, left_direction, right_element)
    tangent2 = get_contravariant_vector(3, interface_vectors, i, j, left_direction, right_element)
    
    flux = surface_flux(u_ll, u_rr, normal, tangent1, tangent2, equations)
